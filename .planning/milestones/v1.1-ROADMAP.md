...
**Completed scope:** Phases 7-15.2
**Deferred beyond this milestone gate:** Phase 16 Long-term / Case Memory, Phase 17 External Action Execution, post-Phase 17 Policy Scope
**Total Plans Completed:** 62

## Overview

v1.1 migrated the v1.0 demo toward explicit, testable agent architecture contracts: knowledge and business facades, state/routing lifecycle, deterministic intent/clarification, PostgreSQL-authoritative session memory, approval/action safety, replay events, memory foundation, and final readiness closure.

The archive below preserves the final pre-archive roadmap snapshot for historical traceability.

---

# Roadmap Snapshot: MOCA v1.1
