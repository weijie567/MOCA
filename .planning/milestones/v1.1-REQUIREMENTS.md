# Requirements Archive: v1.1 Agent Architecture Migration

**Archived:** 2026-06-17
**Status:** SHIPPED
**Current-scope coverage:** 32/32 satisfied
**Deferred beyond this milestone gate:** MEMORY-01..02, EXTERNAL-01..03, tenant-over-global global/default fallback target owner post-Phase 17 `Policy Scope`

For current requirements, start the next milestone with `$gsd-new-milestone`.

---

# Requirements Snapshot: MOCA v1.1 Agent Architecture Migration
