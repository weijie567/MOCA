...
| 34-04-W0 | 04 | 0 | APF-15/APF-16 | T-34-01 / T-34-02 / T-34-04 | agent_runs interrupt bridge preserves Phase 34 bindings and safe approval-required projection. | API/integration | `UV_CACHE_DIR=/tmp/uv-cache uv run pytest tests/test_agent_runs_api.py -q --tb=short` | ✅ | ⬜ pending |
...
- [ ] Update `tests/test_agent_runs_api.py` — preserve Phase 34 binding fields through approval interrupts and keep `approval_required` payloads safe.
