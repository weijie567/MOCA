...
| 10-02-01 | 02 | 1 | ROUTE-02 | T-10-05 | (run_id,sequence) DB-unique; base table chains from 005 | unit | `python -c "from src.db.models import AgentTraceEvent; ..."` | ✅ exists | ⬜ pending |
...
| 10-03-02 | 03 | 2 | ROUTE-01/02 | T-10-08/09/10 | Branch+totality+fine-grained permission-denied precedence | unit/table | `pytest tests/test_graph_routing.py -x -q` | ✅ exists (extend) | ⬜ pending |
| 10-04-01 | 04 | 2 | ROUTE-02 | T-10-11/12/13/14/15 | Bounded loop; allowlist; no write/gate; no evidence_refs | unit | `pytest tests/agent/test_nodes/test_investigate.py -x -q` | ❌ W0 | ⬜ pending |
| 10-04-02 | 04 | 2 | ROUTE-02 | T-10-11/12/13/14/15 | D-03/D-04/D-06/D-08 each proven by executable test | unit/integration | `pytest tests/agent/test_nodes/test_investigate.py -x -q` | ❌ W0 | ⬜ pending |
