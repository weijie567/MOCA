...
| 51-02-02 | 02 | 1 | CAGM-02 | — | Router route values and legacy destinations are source-verified in migration mode | architecture/static | `uv run pytest tests/architecture/test_canonical_graph_baseline.py::test_current_router_mappings_match_source_baseline -q` | ✅ | ✅ green |
