...
- **验证**：terminal/turn/lifecycle focused backend `242 passed`；approval service/API aggregate `110 passed`；approval architecture focused `23 passed`；frontend Vitest `4 files / 30 tests`、production build 通过、mocked desktop/mobile Playwright `10 passed`；相关 Ruff 通过。
