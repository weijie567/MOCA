...
- [ ] **Phase 47: Case Precedent Repositioning and Closed-Case Candidate Generation** - Re-scope `case_memories` as reviewed precedent and add closed-case candidate generation from CWC into governed review flow (MEM-04). Plan progress: 3/4 plans.
...
| 47. Case Precedent Repositioning and Closed-Case Candidate Generation | 3/4 | In Progress | - |
