...
- [ ] **Phase 46: Session Context Repositioning** - Re-scope thread-level session memory after CWC so it remains short-lived conversational context, not cross-case state (MEM-03). Plan progress: 2/3 complete.
...
| 46. Session Context Repositioning | 2/3 complete | In Progress | - |
