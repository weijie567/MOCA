...
**Status:** In Progress — 5/9 plans complete

**Plans:** 5 summaries / 9 plan files in `.planning/phases/16-long-term-case-memory/` (`16-01` through `16-05` complete; `16-06` through `16-09` pending)
...
v1.2 Phase 16 is in progress. Plans `16-01-memory-identity`, `16-02-schema-migration`, `16-03-long-term-memory-service`, `16-04-semantic-episode`, and `16-05-tombstone-supersede` are complete; 4 Phase 16 plans remain.

## Next Step

Continue with `.planning/phases/16-long-term-case-memory/16-06-reviewed-case-memory-PLAN.md`.

---
*Updated: 2026-06-17 - Phase 16 Plan 05 complete.*
