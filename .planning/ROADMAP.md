...
- [ ] **Phase 57: Risk Gate and Approval Gate Canonicalization** - Replace active `assess_risk_and_approval` with canonical `risk_gate` while preserving approval pending/trusted resume semantics (CAGM-08). Plan progress: 0/4 planned.
...
| 57. Risk Gate and Approval Gate Canonicalization | 0/4 | Planned | - |
...
Plans:
- [ ] 57-01-PLAN.md — canonical `risk_gate` callable and Phase 58-scoped `assess_risk_and_approval` compatibility contract.
- [ ] 57-02-PLAN.md — active graph/router/architecture baseline cutover to current-run `risk_gate` route values.
- [ ] 57-03-PLAN.md — trusted approval edit resume canonicalization and risk/approval separation hardening.
- [ ] 57-04-PLAN.md — runtime vocabulary/API/frontend/eval/docs/debt/validation closeout and static legacy-hit classification.
