...
- [ ] **Phase 47: Case Precedent Repositioning and Closed-Case Candidate Generation** - Re-scope `case_memories` as reviewed precedent and add closed-case candidate generation from CWC into governed review flow (MEM-04). Plan progress: 0/4 plans.
...
| 47. Case Precedent Repositioning and Closed-Case Candidate Generation | 0/4 | Planned | - |
...
Plans:
- [ ] 47-01-PLAN.md — contract/static alignment and `closed_case_cwc_candidate` review-required source-type foundation.
