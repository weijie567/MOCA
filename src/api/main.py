...
from src.api.routers import approvals, auth, memory, orders, refund_cases, search, tickets, traces
...
def create_app() -> FastAPI:
    ...
    app.include_router(memory.router, prefix=f"{settings.api_v1_prefix}/memory")
