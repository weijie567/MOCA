...
class ActionToolExecutor:
    ...
    async def execute(self, name: str, args: dict[str, Any], ctx: ToolCallContext) -> ToolResultV2:
        ...
        raw_result = await self.service.create_coupon_grant_draft(
            ...
            target_merchant_id=args.get("target_merchant_id"),
            target_merchant_ref=args.get("target_merchant_ref"),
            business_fact_refs=list(args.get("business_fact_refs") or []),
            verified_evidence_refs=list(args.get("verified_evidence_refs") or []),
            ...
            auto_action_capability_ref=args.get("auto_action_capability_ref"),
