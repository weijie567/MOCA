...
RERANK_STAGE_TIMEOUT_SECONDS = 0.50
RERANK_PROVIDER_ENABLED = False
RERANK_PROVIDER_MAX_RETRIES = 1
RERANK_MAX_CANDIDATES = 50
RERANK_TEXT_MAX_CHARS = 400
RERANK_SCORE_CONFIG_VERSION = "rerank_score.v1"
RETRIEVAL_DIAGNOSTICS_VERSION = "retrieval_diagnostics.v1"
RETRIEVAL_TOTAL_TIMEOUT_SECONDS = 15.0
