...
JOBS = {
    "reminders-sync": Job(
        "reminders-sync", ROOT / "scripts/study/reminders_sync.py", ["--day", "auto", "--sequential", "--write"]
    ),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run study automation once after wake/login, with per-day idempotent markers."
    )
